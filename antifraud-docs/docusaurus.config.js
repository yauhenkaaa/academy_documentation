...
const config = {
  ...
  baseUrl: '/academy_documentation/',
  organizationName: 'yauhenkaaa',
  projectName: 'academy_documentation',
  onBrokenLinks: 'warn',
  ...
  plugins: [
    [require.resolve('docusaurus-plugin-drawio'),
      {
        name: 'docusaurus-plugin-drawio' // Явно задаем имя
      }],
    [
    ...
    [
      ...
      ({
        docs: {
          ...
          routeBasePath: 'docs',
          editUrl:
            'https://github.com/yauhenkaaa/academy_documentation/edit/main/antifraud-docs/',
          remarkPlugins: [simplePlantUML],
        },
        blog: false,
        theme: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/yauhenkaaa/academy_documentation',
            label: 'GitHub',
            position: 'right',
          },
        ],
